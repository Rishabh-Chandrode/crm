...
- `types.test.ts` — Scrape message structure, autofill results, UserProfile contracts, Job, JobApplication, getGmailSearchUrl utility, and JobStatus Trinity synchronization
