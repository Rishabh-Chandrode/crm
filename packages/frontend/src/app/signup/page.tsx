    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Create Account</h1>
          <p className="text-zinc-500 dark:text-zinc-400 text-xs mt-0.5">Join CRM Outreach Suite</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card p-6 sm:p-8 space-y-4 shadow-sm">
          ...
          <div className="relative my-3">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-wider text-zinc-400 dark:text-zinc-500">
              <span className="bg-white dark:bg-zinc-900 px-3">or create with credentials</span>
            </div>
          </div>
          ...
          <div>
            <label className="form-label text-xs">Email <span className="text-zinc-400 font-normal">(optional)</span></label>
            <input
              type="email"
              value={email}
          ...
          <p className="text-center text-xs text-zinc-500 dark:text-zinc-400 pt-1">
            ...
            <Link href="/login" className="text-zinc-900 dark:text-zinc-100 hover:underline font-semibold">
              Sign in
            </Link>
          </p>
        </form>
